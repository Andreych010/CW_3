...
@pytest.fixture
def test_data_is_sorted_same_day():
  return [
  {
    "id": 34148726,
    "state": "EXECUTED",
  ...
  },
  {
    "id": 441945886,
    "state": "CANSELED",
    "date": "2018-11-23T10:50:58.294041",
    "operationAmount": {
      "amount": "31957.58",
      "currency": {
        "name": "руб.",
  ...
  },
  {
    "id": 41428829,
    "state": "EXECUTED",
    "date": "2018-11-23T18:35:29.512364",
    "operationAmount": {
      "amount": "8221.37",
      "currency": {
        "name": "USD",
  ...
  },
  {
    "id": 939719570,
    "state": "EXECUTED",
    "date": "2018-11-23T02:08:58.425572",
    "operationAmount": {
      "amount": "9824.07",
      "currency": {
        "name": "USD",
  ...
  },
  {
    "id": 587085106,
    "state": "EXECUTED",
    "date": "2018-11-23T10:45:06.972075",
    "operationAmount": {
      "amount": "48223.05",
      "currency": {
        "name": "руб.",
...
@pytest.fixture
def test_data_is_valid_input():
  return 1

@pytest.fixture
def test_data_is_convert():
  data = """[{
    "id": 441945886,
    "state": "EXECUTED",
    "date": "2019-08-26T10:50:58.294041",
